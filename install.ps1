...
# Usage: iex (irm https://raw.githubusercontent.com/paoloanzn/free-code/main/install.ps1)
...
function Get-ScriptDir {
    # PowerShell 2.0 does not provide $PSScriptRoot; fall back to $MyInvocation.
